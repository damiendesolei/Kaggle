...
#TR_CSV = "train.csv"
N_TRIALS = 1000
STUDY_NAME = "ms_capital_lgb_20260916"
...
study.trials_dataframe().sort_values("value").to_csv("optuna_trials_lgb_20260916.csv", index=False)
print("\nall trials saved to optuna_trials_lgb_20260916.csv")
...
# Create submission
# --------------------------------------------------------------------------
OUT_CSV = 'lgb_submission_141470.csv'
BASE_PATH = r"H:\kaggle\ms-capital-real-financial-market-forecasting"
tr = pl.read_csv(BASE_PATH+'\\processed_data\\train.csv')
...
params = dict( # 0.136795
    ...
    learning_rate=0.0008377841876329822,
    num_leaves=201, 
    min_data_in_leaf=873,
    feature_fraction=0.8551140982265389,
    bagging_fraction=0.8561605313208401, 
    bagging_freq=7,
    lambda_l1=8.403770394318273e-06,
    lambda_l2=1.1386442143454943e-05, 
    #max_bin=255, 
...
fi_df.write_csv("feature_importance_lgb_20260916.csv")

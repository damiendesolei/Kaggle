...
#TR_CSV = "train.csv"
N_TRIALS = 1000
STUDY_NAME = "ms_capital_lgb_20260917"
...
study.trials_dataframe().sort_values("value").to_csv("optuna_trials_lgb_20260917.csv", index=False)
...
fi_df.write_csv("feature_importance_lgb_20260917.csv")

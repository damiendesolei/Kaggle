...
def create_rolling_features(df, feature, rows):
    ...
    for window in [2*37_000, 3*37_000]:  # ~37_000 rows per day
...
model_name = 'lgb_random_with_diff_comb_plus_lag_plus_roll_187'
...
lgb_feature_importance.to_csv(model_path + 'lgb_random_with_diff_comb_plus_lag_plus_roll_187_0.csv', index=False)

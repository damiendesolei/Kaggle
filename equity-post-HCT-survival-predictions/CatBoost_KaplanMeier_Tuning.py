    ...
    for i, (train_index, test_index) in enumerate(kf.split(train)):       
        ...
        for j,f in enumerate(FEATURES+lists2):
            ...
            if j>=len(FEATURES):
                ...
                x_train, x_valid, x_test = target_encode(x_train, x_valid, x_test, c, smooth=0, agg="std")
                x_train, x_valid, x_test = target_encode(x_train, x_valid, x_test, c, smooth=0, agg="skew")
...
file_name = f"Cb_with_KaplanMeier_mae_{best_score:.6f}.csv"
